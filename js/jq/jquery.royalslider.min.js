! function(e) {
    function i(i, t) {
        ...
        var a, d = document.createElement("div").style,
            l = ["webkit", "Moz", "ms", "O"],
            _ = "",
            c = 0;
        for (s = 0; s < l.length; s++) a = l[s], !_ && a + "Transform" in d && (_ = a), a = a.toLowerCase(), window.requestAnimationFrame || (window.requestAnimationFrame = window[a + "RequestAnimationFrame"], window.cancelAnimationFrame = window[a + "CancelAnimationFrame"] || window[a + "CancelRequestAnimationFrame"]);
        window.requestAnimationFrame || (window.requestAnimationFrame = function(e, i) {
            ...
            clearTimeout(e)
        }), n.isIPAD = o.match(/(ipad)/), n.isIOS = n.isIPAD || o.match(/(iphone|ipod)/), s = function(e) {
            return e = /(chrome)[ \/]([\w.]+)/.exec(e) || /(webkit)[ \/]([\w.]+)/.exec(e) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(e) || /(msie) ([\w.]+)/.exec(e) || 0 > e.indexOf("compatible") && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(e) || [], {
                browser: e[1] || "",
                version: e[2] || "0"
            }
        }(o), l = {}, s.browser && (l[s.browser] = !0, l.version = s.version), l.chrome && (l.webkit = !0), n._a = l, n.isAndroid = -1 < o.indexOf("android"), n.slider = e(i), n.ev = e(n), n._b = e(document), n.st = e.extend({}, e.fn.royalSlider.defaults, t), n._c = n.st.transitionSpeed, n._d = 0, !n.st.allowCSS3 || l.webkit && !n.st.allowCSS3OnWebkit || (s = _ + (_ ? "T" : "t"), n._e = s + "ransform" in d && s + "ransition" in d, n._e && (n._f = _ + (_ ? "P" : "p") + "erspective" in d)), _ = _.toLowerCase(), n._g = "-" + _ + "-", n._h = "vertical" === n.st.slidesOrientation ? !1 : !0, n._i = n._h ? "left" : "top", n._j = n._h ? "width" : "height", n._k = -1, n._l = "fade" === n.st.transitionType ? !1 : !0, n._l || (n.st.sliderDrag = !1, n._m = 10), n._n = "z-index:0; display:none; opacity:0;", n._o = 0, n._p = 0, n._q = 0, e.each(e.rsModules, function(e, i) {
            "uid" !== e && i.call(n)
        ...
        }), n.numSlides = n.slides.length, n._t(), n.st.startSlideId ? n.st.startSlideId > n.numSlides - 1 && (n.st.startSlideId = n.numSlides - 1) : n.st.startSlideId = 0, n._o = n.staticSlideId = n.currSlideId = n._u = n.st.startSlideId, n.currSlide = n.slides[n.currSlideId], n._v = 0, n.pointerMultitouch = !1, n.slider.addClass((n._h ? "rsHor" : "rsVer") + (n._l ? "" : " rsFade")), d = '<div class="rsOverflow"><div class="rsContainer">', n.slidesSpacing = n.st.slidesSpacing, n._w = (n._h ? n.slider.width() : n.slider.height()) + n.st.slidesSpacing, n._x = Boolean(0 < n._y), 1 >= n.numSlides && (n._z = !1), n._a1 = n._z && n._l ? 2 === n.numSlides ? 1 : 2 : 0, n._b1 = 6 > n.numSlides ? n.numSlides : 6, n._c1 = 0, n._d1 = 0, n.slidesJQ = [];
        ...
        e(window).on("resize" + n.ns, function() {
            ...
            n._f2()
        }), n._f2()), n.st.arrowBottom && (r = n._o1, e('<div class="rsBottom"><div class="rsArrowBottomIcn"></div></div>').appendTo(r), n._c2 = r.children(".rsBottom").click(function(e) {
            e.preventDefault();
            var i = jQuery("#content").offset().top;
            return -1 != navigator.userAgent.indexOf("Safari") ? jQuery("body").animate({
                scrollTop: i
            }, 1100) : jQuery("html").animate({
                scrollTop: i
            }, 1100), !1
        }), n.ev.on("rsOnUpdateNav", function() {
            n._f2()
    ...
    e.rsModules || (e.rsModules = {
            ...
            function s(e, i) {
                if (i ? a.images.push(e.attr(i)) : a.images.push(e.text()), d) {
                    ...
                    var t = e.attr("data-rsw"),
                        s = e.attr("data-rsh");
                    "undefined" != typeof t && !1 !== t && "undefined" != typeof s && !1 !== s ? (a.iW = parseInt(t, 10), a.iH = parseInt(s, 10)) : o.st.imgWidth && o.st.imgHeight && (a.iW = o.st.imgWidth, a.iH = o.st.imgHeight)
                }
            }
            var n, r, o = this,
                a = {},
                d = !0;
            return i = e(i), o._k2 = i, o.ev.trigger("rsBeforeParseNode", [i, a]), a.stopParsing ? void 0 : (i = o._k2, a.id = o._r, a.contentAdded = !1, o._r++, a.images = [], a.isBig = !1, a.hasCover || (i.hasClass("rsImg") ? (r = i, n = !0) : (r = i.find(".rsImg"), r.length && (n = !0)), n ? (a.bigImage = r.eq(0).attr("data-rsBigImg"), r.each(function() {
                var i = e(this);
                i.is("a") ? s(i, "href") : i.is("img") ? s(i, "src") : s(i)
            })) : i.is("img") && (i.addClass("rsImg rsMainSlideImage"), s(i, "src"))), r = i.find(".rsCaption"), r.length && (a.caption = r.remove()), a.content = i, o.ev.trigger("rsAfterParseNode", [i, a]), t && o.slides.push(a), 0 === a.images.length && (a.isLoaded = !0, a.isRendered = !1, a.isLoading = !1, a.images = null), a)
        },
        _b2: function() {
            var e, i, t = this,
                s = function(e) {
            ...
            t._b.on("keydown" + t.ns, function(n) {
                if (!t.st.keyboardNavEnabled) return !0;
                if (!(t._l2 || (i = n.keyCode, 37 !== i && 39 !== i || e))) {
                    if (document.activeElement && /(INPUT|SELECT|TEXTAREA)/i.test(document.activeElement.tagName)) return !0;
                    t.isFullscreen && n.preventDefault(), s(i), e = setInterval(function() {
                        s(i)
                    }, 700)
                }
        ...
        destroy: function(i) {
            this.ev.trigger("rsBeforeDestroy"), this._b.off("keydown" + this.ns + " keyup" + this.ns + " " + this._k1 + " " + this._l1), this._p1.off(this._j1 + " click"), this.slider.data("royalSlider", null), e.removeData(this.slider, "royalSlider"), e(window).off("resize" + this.ns), this.loadingTimeout && clearTimeout(this.loadingTimeout), i && this.slider.remove(), this.ev = this.slider = this.slides = null
        },
        _n2: function(i, t) {
            function s(t, s, o) {
            ...
            if (g)
                for (d = f; f + m + 1 > d; d++) h = o(d), u = Math.floor((l._u - (f - d)) / l.numSlides) * l.numSlides, (a = l.slides[h]) && s(a, h);
            if (p)
                for (d = f - 1; d > f - 1 - m; d--) h = o(d), u = Math.floor((l._u - (f - d)) / c) * c, (a = l.slides[h]) && s(a, h);
            if (!i)
                for (v = o(f - m), f = o(f + m), m = v > f ? 0 : v, d = 0; c > d; d++) v > f && d > v - 1 || !(m > d || d > f) || (a = l.slides[d]) && a.holder && (a.holder.detach(), a.isAdded = !1)
        },
            ...
            var s = this,
                n = function() {
                    if (i.images) {
                        if (!i.isLoading) {
                            var t, n;
                            if (i.content.hasClass("rsImg") ? (t = i.content, n = !0) : t = i.content.find(".rsImg:not(img)"), t && !t.is("img") && t.each(function() {
                                    var t = e(this),
                                        s = '<img class="rsImg" src="' + (t.is("a") ? t.attr("href") : t.text()) + '" />';
                                    n ? i.content = e(s) : t.replaceWith(s)
                                }), t = n ? i.content : i.content.find("img.rsImg"), l(), t.eq(0).addClass("rsMainSlideImage"), i.iW && i.iH && (i.isLoaded || s._q2(i), a()), i.isLoading = !0, i.isBig) e("<img />").on("load.rs error.rs", function(i) {
                                e(this).off("load.rs error.rs"), r([this], !0)
                            }).attr("src", i.image);
                            else {
                                i.loaded = [], i.numStartedLoad = 0, t = function(t) {
                ...
                a = function() {
                    if (!i.isAppended && s.ev) {
                        var e = s.st.visibleNearby,
                            n = i.id - s._o;
                        t || i.appendOnLoaded || !s.st.fadeinLoadedSlide || 0 !== n && (!(e || s._r2 || s._l2) || -1 !== n && 1 !== n) || (e = {
                            visibility: "visible",
                            opacity: 0
                        }, e[s._g + "transition"] = "opacity 400ms ease-in-out", i.content.css(e), setTimeout(function() {
                            i.content.css("opacity", 1)
                        }, 16)), i.holder.find(".rsPreloader").length ? i.holder.append(i.content) : i.holder.html(i.content), i.isAppended = !0, i.isLoaded && (s._q2(i), d()), i.sizeReady || (i.sizeReady = !0, setTimeout(function() {
                ...
                _ = function(e) {
                    s.st.usePreloader && (e = i.holder.find(".rsPreloader"), e.length && e.remove())
                };
        ...
        _g2: function(i, t) {
            ...
            if (!t && n._r2 && (n._t2 = !0, n._u2()), n.dragSuccess = !1, n._l2) r && (n._v2 = !0);
                ...
                n._l2 = !0, n._b.on(n._k1, function(e) {
                    ...
                    n._y2(e, t)
                }), n._z2 = "", n._a3 = !1, n._b3 = s.pageX, n._c3 = s.pageY, n._d3 = n._v = (t ? n._e3 : n._h) ? s.pageX : s.pageY, n._f3 = 0, n._g3 = 0, n._h3 = t ? n._i3 : n._p, n._j3 = (new Date).getTime(), r && n._e1.on(n._m1, function(e) {
                    n._y2(e, t)
                })
            }
        },
        _k3: function(e, i) {
            if (this._l3) {
                var t = this._m3,
                    ...
                    r = a ? r : o,
                    o = this._z2;
                this._a3 = !0, this._b3 = e.pageX, this._c3 = e.pageY, "x" === o && 0 !== s ? this._f3 = s > 0 ? 1 : -1 : "y" === o && 0 !== n && (this._g3 = n > 0 ? 1 : -1), o = a ? this._b3 : this._c3, s = a ? s : n, i ? r > this._n3 ? r = this._h3 + s * this._n1 : r < this._o3 && (r = this._h3 + s * this._n1) : this._z || (0 >= this.currSlideId && 0 < o - this._d3 && (r = this._h3 + s * this._n1), this.currSlideId >= this.numSlides - 1 && 0 > o - this._d3 && (r = this._h3 + s * this._n1)), this._h3 = r, 200 < t - this._j3 && (this._j3 = t, this._v = o), i ? this._q3(this._h3) : this._l && this._p3(this._h3)
            }
        },
        _x2: function(e, i) {
            var t, s = this,
            ...
            if (!s._s2 || n) {
                ...
                if (s._a3 || (s._e && (i ? s._s3 : s._p1).css(s._g + s._u1, "0s"), function o() {
                        s._l2 && (s._t3 = requestAnimationFrame(o), s._u3 && s._k3(s._u3, i))
                    }()), s._l3) e.preventDefault(), s._m3 = (new Date).getTime(), s._u3 = t;
                else if (r = i ? s._e3 : s._h, t = Math.abs(t.pageX - s._b3) - Math.abs(t.pageY - s._c3) - (r ? -7 : 7), t > 7) {
        ...
        _y2: function(i, t) {
            ...
            if (r = -1 < i.type.indexOf("touch"), !l._s2 || r)
                if (l._s2 = !1, l.ev.trigger("rsDragRelease"), l._u3 = null, l._l2 = !1, l._r3 = !1, l._l3 = !1, l._m3 = 0, cancelAnimationFrame(l._t3), l._a3 && (t ? l._q3(l._h3) : l._l && l._p3(l._h3)), l._b.off(l._k1).off(l._l1), r && l._e1.off(l._m1), l._i1(), !l._a3 && !l._v2 && t && l._w3) {
                    ...
                    var f = l.currSlideId,
                        ...
                        v = o ? l._f3 : l._g3,
                        g = l._z;
                    if (Math.abs(u - h), r = u - r, o = (new Date).getTime() - l._j3, o = Math.abs(r) / o, 0 === v || 1 >= m) n(!0, o);
                    else {
                        if (!g && !t)
                            if (0 >= f) {
                                if (v > 0) return void n(!0, o)
                            } else if (f >= m - 1 && 0 > v) return void n(!0, o);
                        if (t) {
                            if (a = l._i3, a > l._n3) a = l._n3;
                            else if (a < l._o3) a = l._o3;
                            else {
                                if (u = o * o / .006, _ = -l._i3, h = l._y3 - l._z3 + l._i3, r > 0 && u > _ ? (_ += l._z3 / (15 / (u / o * .003)), o = o * _ / u, u = _) : 0 > r && u > h && (h += l._z3 / (15 / (u / o * .003)), o = o * h / u, u = h), _ = Math.max(Math.round(o / .003), 50), a += u * (0 > r ? -1 : 1), a > l._n3) return void l._a4(a, _, !0, l._n3, 200);
                        ...
                        }, u > h + c ? 0 > v ? n(!1, o) : (_ = _(u - h), l._m2(l.currSlideId - _, s(Math.abs(l._p - (-l._u - l._d1 + _) * l._w) / o), !1, !0, !0)) : h - c > u ? v > 0 ? n(!1, o) : (_ = _(h - u), l._m2(l.currSlideId + _, s(Math.abs(l._p - (-l._u - l._d1 - _) * l._w) / o), !1, !0, !0)) : n(!1, o)
                    }
                }
        },
        _p3: function(e) {
        ...
        updateSliderSize: function(e) {
            ...
            if (this.slider) {
                if (this.st.autoScaleSlider) {
                    ...
                    this.st.autoScaleHeight ? (i = this.slider.width(), i != this.width && (this.slider.css("height", n / s * i), i = this.slider.width()), t = this.slider.height()) : (t = this.slider.height(), t != this.height && (this.slider.css("width", s / n * t), t = this.slider.height()), i = this.slider.width())
                } else i = this.slider.width(), t = this.slider.height();
                if (e || i != this.width || t != this.height) {
                    for (this.width = i, this.height = t, this._b4 = i, this._c4 = t, this.ev.trigger("rsBeforeSizeSet"), this.ev.trigger("rsAfterSizePropSet"), this._e1.css({
                            width: this._b4,
                            height: this._c4
                        }), this._w = (this._h ? this._b4 : this._c4) + this.st.slidesSpacing, this._d4 = this.st.imageScalePadding, i = 0; i < this.slides.length; i++) e = this.slides[i], e.positionSet = !1, e && e.images && e.isLoaded && (e.isRendered = !1, this._q2(e));
                    if (this._e4)
                        for (i = 0; i < this._e4.length; i++) e = this._e4[i], e.holder.css(this._i, (e.id + this._d1) * this._w);
        ...
        appendSlide: function(i, t) {
            var s = this._s(i);
            (isNaN(t) || t > this.numSlides) && (t = this.numSlides), this.slides.splice(t, 0, s), this.slidesJQ.splice(t, 0, e('<div style="' + (this._l ? "position:absolute;" : this._n) + '" class="rsSlide"></div>')), t <= this.currSlideId && this.currSlideId++, this.ev.trigger("rsOnAppendSlide", [s, t]), this._f4(t), t === this.currSlideId && this.ev.trigger("rsAfterSlideChange")
        },
        removeSlide: function(e) {
            var i = this.slides[e];
            i && (i.holder && i.holder.remove(), e < this.currSlideId && this.currSlideId--, this.slides.splice(e, 1), this.slidesJQ.splice(e, 1), this.ev.trigger("rsOnRemoveSlide", [e]), this._f4(e), e === this.currSlideId && this.ev.trigger("rsAfterSlideChange"))
        },
        _f4: function(e) {
            var i = this;
            for (e = i.numSlides, e = 0 >= i._u ? 0 : Math.floor(i._u / e), i.numSlides = i.slides.length, 0 === i.numSlides ? (i.currSlideId = i._d1 = i._u = 0, i.currSlide = i._g4 = null) : i._u = e * i.numSlides + i.currSlideId, e = 0; e < i.numSlides; e++) i.slides[e].id = e;
            i.currSlide = i.slides[i.currSlideId], i._r1 = i.slidesJQ[i.currSlideId], i.currSlideId >= i.numSlides ? i.goTo(i.numSlides - 1) : 0 > i.currSlideId && i.goTo(0), i._t(), i._l && i._p1.css(i._g + i._u1, "0ms"), i._h4 && clearTimeout(i._h4), i._h4 = setTimeout(function() {
                i._l && i._p3((-i._u - i._d1) * i._w), i._n2(), i._l || i._r1.css({
                    display: "block",
                    opacity: 1
                })
            }, 14), i.ev.trigger("rsOnUpdateNav")
        },
        _i1: function() {
        ...
        _m2: function(e, i, t, s, n) {
            ...
            var l = d.currSlideId + o;
            s = d._u;
            var _;
            d._z ? (l = d._n2(!1, l), s += o) : s = l, d._o = l, d._g4 = d.slidesJQ[d.currSlideId], d._u = s, d.currSlideId = d._o, d.currSlide = d.slides[d.currSlideId], d._r1 = d.slidesJQ[d.currSlideId];
            var l = d.st.slidesDiff,
                c = Boolean(o > 0);
            o = Math.abs(o);
            var u = Math.floor(a / d._y),
                h = Math.floor((a + (c ? l : -l)) / d._y),
                u = (c ? Math.max(u, h) : Math.min(u, h)) * d._y + (c ? d._y - 1 : 0);
            if (u > d.numSlides - 1 ? u = d.numSlides - 1 : 0 > u && (u = 0), a = c ? u - a : a - u, a > d._y && (a = d._y), o > a + l)
                for (d._d1 += (o - (a + l)) * (c ? -1 : 1), i *= 1.4, a = 0; a < d.numSlides; a++) d.slides[a].positionSet = !1;
            d._c = i, d._n2(!0), n || (_ = !0), r = (-s - d._d1) * d._w, _ ? setTimeout(function() {
                d._j4 = !1, d._x3(r, e, !1, t), d.ev.trigger("rsOnUpdateNav")
            }, 0) : (d._x3(r, e, !1, t), d.ev.trigger("rsOnUpdateNav"))
        },
        _f2: function() {
        ...
        _x3: function(i, t, s, n, r) {
            function o() {
                var e;
                a && (e = a.data("rsTimeout")) && (a !== d && a.css({
                    opacity: 0,
                    display: "none",
                    zIndex: 0
                }), clearTimeout(e), a.data("rsTimeout", "")), (e = d.data("rsTimeout")) && (clearTimeout(e), d.data("rsTimeout", ""))
            }
            var a, d, l = this,
                _ = {};
            isNaN(l._c) && (l._c = 400), l._p = l._h3 = i, l.ev.trigger("rsBeforeAnimStart"), l._e ? l._l ? (l._c = parseInt(l._c, 10), s = l._g + l._v1, _[l._g + l._u1] = l._c + "ms", _[s] = n ? e.rsCSS3Easing[l.st.easeInOut] : e.rsCSS3Easing[l.st.easeOut], l._p1.css(_), n || !l.hasTouch ? setTimeout(function() {
                l._p3(i)
            }, 5) : l._p3(i)) : (l._c = l.st.transitionSpeed, a = l._g4, d = l._r1, d.data("rsTimeout") && d.css("opacity", 0), o(), a && a.data("rsTimeout", setTimeout(function() {
                _[l._g + l._u1] = "0ms", _.zIndex = 0, _.display = "none", a.data("rsTimeout", ""), a.css(_), setTimeout(function() {
                    a.css("opacity", 0)
                }, 16)
            }, l._c + 60)), _.display = "block", _.zIndex = l._m, _.opacity = 0, _[l._g + l._u1] = "0ms", _[l._g + l._v1] = e.rsCSS3Easing[l.st.easeInOut], d.css(_), d.data("rsTimeout", setTimeout(function() {
                d.css(l._g + l._u1, l._c + "ms"), d.data("rsTimeout", setTimeout(function() {
                    d.css("opacity", 1), d.data("rsTimeout", "")
                }, 20))
            }, 20))) : l._l ? (_[l._h ? l._x1 : l._w1] = i + "px", l._p1.animate(_, l._c, n ? l.st.easeInOut : l.st.easeOut)) : (a = l._g4, d = l._r1, d.stop(!0, !0).css({
                opacity: 0,
                display: "block",
                zIndex: l._m
            }), l._c = l.st.transitionSpeed, d.animate({
                opacity: 1
            }, l._c, l.st.easeInOut), o(), a && a.data("rsTimeout", setTimeout(function() {
                a.stop(!0, !0).css({
                    opacity: 0,
                    display: "none",
                    zIndex: 0
                })
            }, l._c + 60))), l._r2 = !0, l.loadingTimeout && clearTimeout(l.loadingTimeout), l.loadingTimeout = r ? setTimeout(function() {
        ...
        _q2: function(i, t) {
            if (!i.isRendered) {
                ...
                if (i.videoURL && (o = "rsVideoContainer", "fill" !== d ? s = !0 : (n = r, n.hasClass(o) || (n = n.find("." + o)), n.css({
                        width: "100%",
                        height: "100%"
                    ...
                    if (i.isRendered = !0, "none" !== d || a) {
                        ...
                        var c, u, h = this._c4 - 2 * o,
                            f = {};
                        "fit-if-smaller" === d && (l > n || _ > h) && (d = "fit"), ("fill" === d || "fit" === d) && (c = n / l, u = h / _, c = "fill" == d ? c > u ? c : u : "fit" == d ? u > c ? c : u : 1, l = Math.ceil(l * c, 10), _ = Math.ceil(_ * c, 10)), "none" !== d && (f.width = l, f.height = _, s && r.find(".rsImg").css({
                            width: "100%",
                            height: "100%"
                        })), a && (f.marginLeft = Math.floor((n - l) / 2) + o, f.marginTop = Math.floor((h - _) / 2) + o), r.css(f)
                    }
                }
            }
        }
    }, e.rsProto = i.prototype, e.fn.royalSlider = function(t) {
        var s = arguments;
...
function(e) {
    e.extend(e.rsProto, {
        _i5: function() {
            var i = this;
            "bullets" === i.st.controlNavigation && (i.ev.one("rsAfterPropsSetup", function() {
                ...
                i._k5 = t = e(t + "</div>"), i._l5 = t.appendTo(i.slider).children(), i._k5.on("click.rs", ".rsNavItem", function(t) {
                ...
                var e = i.currSlideId;
                i._n5 && i._n5.removeClass("rsNavSelected"), e = i._l5.eq(e), e.addClass("rsNavSelected"), i._n5 = e
            }))
        }
...
function(e) {
    e.extend(e.rsProto, {
        _h6: function() {
            var i = this;
            "thumbnails" === i.st.controlNavigation && (i._i6 = {
                drag: !0,
                touch: !0,
                ...
                paddingTop: 0,
                paddingBottom: 0
            }, i.st.thumbs = e.extend({}, i._i6, i.st.thumbs), i._j6 = !0, !1 === i.st.thumbs.firstMargin ? i.st.thumbs.firstMargin = 0 : !0 === i.st.thumbs.firstMargin && (i.st.thumbs.firstMargin = i.st.thumbs.spacing), i.ev.on("rsBeforeParseNode", function(i, t, s) {
                t = e(t), s.thumbnail = t.find(".rsTmb").remove(), s.thumbnail.length ? s.thumbnail = e(document.createElement("div")).append(s.thumbnail).html() : (s.thumbnail = t.attr("data-rsTmb"), s.thumbnail || (s.thumbnail = t.find(".rsImg").attr("data-rsTmb")), s.thumbnail = s.thumbnail ? '<img src="' + s.thumbnail + '" alt="'+t.find(".rsImg").attr("alt")+'"/>' : "")
            }), i.ev.one("rsAfterPropsSetup", function() {
                i._k6()
            }), i._n5 = null, i.ev.on("rsOnUpdateNav", function() {
                ...
                e = "<div" + i._n6 + ' class="rsNavItem rsThumb">' + i._o6 + t.thumbnail + "</div>", i._e && i._s3.css(i._g + "transition-duration", "0ms"), s >= i.numSlides ? i._s3.append(e) : i._l5.eq(s).before(e), i._l5 = i._s3.children(), i.updateThumbsSize(!0)
            }), i.ev.on("rsOnRemoveSlide", function(e, t) {
                var s = i._l5.eq(t);
        ...
        _k6: function() {
            var i, t, s = this,
                ...
                o = "",
                a = r.spacing;
            s._j5 = !0, s._e3 = "vertical" === r.orientation ? !1 : !0, s._n6 = i = a ? ' style="margin-' + (s._e3 ? "right" : "bottom") + ":" + a + 'px;"' : "", s._i3 = 0, s._p6 = !1, s._m5 = !1, s._l6 = !1, s._q6 = r.arrows && r.navigation, t = s._e3 ? "Hor" : "Ver", s.slider.addClass("rsWithThumbs rsWithThumbs" + t), o += '<div class="rsNav rsThumbs rsThumbs' + t + '"><div class="' + n + 'Container">', s._o6 = r.appendSpan ? '<span class="thumbIco"></span>' : "";
            for (var d = 0; d < s.numSlides; d++) t = s.slides[d], o += "<div" + i + ' class="rsNavItem rsThumb">' + t.thumbnail + s._o6 + "</div>";
            o = e(o + "</div></div>"), i = {}, r.paddingTop && (i[s._e3 ? "paddingTop" : "paddingLeft"] = r.paddingTop), r.paddingBottom && (i[s._e3 ? "paddingBottom" : "paddingRight"] = r.paddingBottom), o.css(i), s._s3 = e(o).find("." + n + "Container"), s._q6 && (n += "Arrow", r.arrowLeft ? s._r6 = r.arrowLeft : (s._r6 = e('<div class="' + n + " " + n + 'Left"><div class="' + n + 'Icn"></div></div>'), o.append(s._r6)), r.arrowRight ? s._s6 = r.arrowRight : (s._s6 = e('<div class="' + n + " " + n + 'Right"><div class="' + n + 'Icn"></div></div>'), o.append(s._s6)), s._r6.click(function() {
            ...
            }))), s._k5 = o, s._l5 = s._s3.children(), s.msEnabled && s.st.thumbs.navigation && s._s3.css("-ms-touch-action", s._e3 ? "pan-y" : "pan-x"), s.slider.append(o), s._w3 = !0, s._v6 = a, r.navigation && s._e && s._s3.css(s._g + "transition-property", s._g + "transform"), s._k5.on("click.rs", ".rsNavItem", function(i) {
        ...
        _a4: function(i, t, s, n, r) {
            ...
            if (o._l6) {
                ...
                var a = {};
                o._p6 = !0, o._e ? (a[o._g + "transition-duration"] = t + "ms", a[o._g + "transition-timing-function"] = s ? e.rsCSS3Easing[o.st.easeOut] : e.rsCSS3Easing[o.st.easeInOut], o._s3.css(a), o._q3(i)) : (a[o._e3 ? o._x1 : o._w1] = i + "px", o._s3.animate(a, t, s ? "easeOutCubic" : o.st.easeInOut)),
...
function(e) {
    e.extend(e.rsProto, {
        _f6: function() {
            var i = this;
            "tabs" === i.st.controlNavigation && (i.ev.on("rsBeforeParseNode", function(i, t, s) {
                t = e(t), s.thumbnail = t.find(".rsTmb").remove(), s.thumbnail.length ? s.thumbnail = e(document.createElement("div")).append(s.thumbnail).html() : (s.thumbnail = t.attr("data-rsTmb"), s.thumbnail || (s.thumbnail = t.find(".rsImg").attr("data-rsTmb")), s.thumbnail = s.thumbnail ? '<img src="' + s.thumbnail + '"/>' : "")
            }), i.ev.one("rsAfterPropsSetup", function() {
                i._g6()
            }), i.ev.on("rsOnAppendSlide", function(e, t, s) {
        ...
        _g6: function() {
            ...
            i = e(i + "</div>"), t._k5 = i, t._l5 = i.children(".rsNavItem"), t.slider.append(i), t._k5.click(function(i) {
                i = e(i.target).closest(".rsNavItem"), i.length && t.goTo(i.index())
            })
        }
    ...
    e.extend(e.rsProto, {
        _q5: function() {
            ...
            i._r5 = {
                ...
                nativeFS: !1,
                doubleTap: !0
            }, i.st.fullscreen = e.extend({}, i._r5, i.st.fullscreen), i.st.fullscreen.enabled && i.ev.one("rsBeforeSizeSet", function() {
                i._s5()
            })
        },
        _s5: function() {
            ...
            if (i._t5 = !i.st.keyboardNavEnabled && i.st.fullscreen.keyboardNav, i.st.fullscreen.nativeFS) {
                ...
                if ("undefined" != typeof document.cancelFullScreen) t.supportsFullScreen = !0;
                    ...
                    for (var n = 0, r = s.length; r > n; n++)
                        if (t.prefix = s[n], "undefined" != typeof document[t.prefix + "CancelFullScreen"]) {
                            t.supportsFullScreen = !0;
                            break
                        }
                t.supportsFullScreen ? (i.nativeFS = !0, t.fullScreenEventName = t.prefix + "fullscreenchange" + i.ns, t.isFullScreen = function() {
                    switch (this.prefix) {
                        case "":
            ...
            i.st.fullscreen.buttonFS && (i._v5 = e('<div class="rsFullscreenBtn"><div class="rsFullscreenIcn"></div></div>').appendTo(i._o1).on("click.rs", function() {
        ...
        enterFullscreen: function(i) {
            var t = this;
            if (t._u5) {
                if (!i) return t._b.on(t._u5.fullScreenEventName, function(e) {
            ...
            if (!t._w5) {
                t._w5 = !0, t._b.on("keyup" + t.ns + "fullscreen", function(e) {
                    27 === e.keyCode && t.exitFullscreen()
                }), t._t5 && t._b2(), i = e(window), t._x5 = i.scrollTop(), t._y5 = i.scrollLeft(), t._z5 = e("html").attr("style"), t._a6 = e("body").attr("style"), t._b6 = t.slider.attr("style"), e("body, html").css({
                    overflow: "hidden",
                    height: "100%",
                    width: "100%",
                    margin: "0",
                ...
                var s;
                for (s = 0; s < t.numSlides; s++) i = t.slides[s], i.isRendered = !1, i.bigImage && (i.isBig = !0, i.isMedLoaded = i.isLoaded, i.isMedLoading = i.isLoading, i.medImage = i.image, i.medIW = i.iW, i.medIH = i.iH, i.slideId = -99, i.bigImage !== i.medImage && (i.sizeType = "big"), i.isLoaded = i.isBigLoaded, i.isLoading = !1, i.image = i.bigImage, i.images[0] = i.bigImage, i.iW = i.bigIW, i.iH = i.bigIH, i.isAppended = i.contentAdded = !1, t._c6(i));
        ...
        exitFullscreen: function(i) {
            ...
            if (!t._w5) {
                t._w5 = !0, t._b.off("keyup" + t.ns + "fullscreen"), t._t5 && t._b.off("keydown" + t.ns), e("html").attr("style", t._z5 || ""), e("body").attr("style", t._a6 || "");
                var s;
                for (s = 0; s < t.numSlides; s++) i = t.slides[s], i.isRendered = !1, i.bigImage && (i.isBig = !1, i.slideId = -99, i.isBigLoaded = i.isLoaded, i.isBigLoading = i.isLoading, i.bigImage = i.image, i.bigIW = i.iW, i.bigIH = i.iH, i.isLoaded = i.isMedLoaded, i.isLoading = !1, i.image = i.medImage, i.images[0] = i.medImage, i.iW = i.medIW, i.iH = i.medIH, i.isAppended = i.contentAdded = !1, t._c6(i, !0), i.bigImage !== i.medImage && (i.sizeType = "med"));
                t.isFullscreen = !1, i = e(window), i.scrollTop(t._x5), i.scrollLeft(t._y5), t._w5 = !1, t.slider.removeClass("rsFullscreen"), t.updateSliderSize(), setTimeout(function() {
                    t.updateSliderSize()
                }, 1), t.ev.trigger("rsExitFullscreen")
            }
        },
        _c6: function(i, t) {
    ...
    e.extend(e.rsProto, {
        _x4: function() {
            ...
            t._y4 = {
                ...
                pauseOnHover: !0,
                delay: 2e3
            }, !t.st.autoPlay && t.st.autoplay && (t.st.autoPlay = t.st.autoplay), t.st.autoPlay = e.extend({}, t._y4, t.st.autoPlay), t.st.autoPlay.enabled && (t.ev.on("rsBeforeParseNode", function(t, s, n) {
        ...
        _z4: function() {
            ...
            }), i._e5 = !1, i.ev.on("rsVideoStop", function() {
                i._a5 && (i._e5 = !1, i._b5())
            }), i.ev.on("rsVideoPlay", function() {
                i._a5 && (i._c5 = !1, i._d5(), i._e5 = !0)
            }), e(window).on("blur" + i.ns, function() {
                i._a5 && (i._c5 = !0, i._d5())
            }).on("focus" + i.ns, function() {
                i._a5 && i._c5 && (i._c5 = !1, i._b5())
            }), i.st.autoPlay.pauseOnHover && (i._f5 = !1, i.slider.hover(function() {
...
function(e) {
    e.extend(e.rsProto, {
        _z6: function() {
            ...
            }, i.st.video = e.extend({}, i._a7, i.st.video), i.ev.on("rsBeforeSizeSet", function() {
                i._b7 && setTimeout(function() {
                    var e = i._r1,
        ...
        _f7: function(e, i) {
            var t = [],
                s = this.st.video;
            if (s.autoHideArrows && (this._c2 && (t.push(this._c2, this._d2), this._e2 = !e), this._v5 && t.push(this._v5)), s.autoHideControlNav && this._k5 && t.push(this._k5), s.autoHideBlocks && this._d7.animBlocks && t.push(this._d7.animBlocks), s.autoHideCaption && this.globalCaption && t.push(this.globalCaption), this.slider[e ? "removeClass" : "addClass"]("rsVideoPlaying"), t.length)
    ...
    e.extend(e.rsProto, {
        _p4: function() {
            ...
            s._q4 = {
                ...
                t.id === s.slides[s.currSlideId].id && setTimeout(function() {
                    i()
        ...
        _u4: function(i) {
            var t, s, n, r, o, a, d, l = this;
            l._s4 = [], i.each(function(i) {
                t = e(this), s = {}, n = {}, r = null;
                var _ = t.attr("data-move-offset"),
                    _ = _ ? parseInt(_, 10) : l.st.block.moveOffset;
                if (_ > 0 && ((a = t.data("move-effect")) ? (a = a.toLowerCase(), "none" === a ? a = !1 : "left" !== a && "top" !== a && "bottom" !== a && "right" !== a && (a = l.st.block.moveEffect, "none" === a && (a = !1))) : a = l.st.block.moveEffect, a && "none" !== a)) {
                    var c;
                    c = "right" === a || "left" === a ? !0 : !1;
                    var u;
                    d = !1, l._e ? (u = 0, o = l._x1) : (c ? isNaN(parseInt(t.css("right"), 10)) ? o = "left" : (o = "right", d = !0) : isNaN(parseInt(t.css("bottom"), 10)) ? o = "top" : (o = "bottom", d = !0), o = "margin-" + o, d && (_ = -_), l._e ? u = parseInt(t.css(o), 10) : (u = t.data("rs-start-move-prop"), void 0 === u && (u = parseInt(t.css(o), 10), isNaN(u) && (u = 0), t.data("rs-start-move-prop", u)))), n[o] = l._m4("top" === a || "left" === a ? u - _ : u + _, c), s[o] = l._m4(u, c)
                }
                _ = t.attr("data-fade-effect"), _ ? ("none" === _.toLowerCase() || "false" === _.toLowerCase()) && (_ = !1) : _ = l.st.block.fadeEffect, _ && (n.opacity = 0, s.opacity = 1), (_ || a) && (r = {}, r.hasFade = Boolean(_), Boolean(a) && (r.moveProp = o, r.hasMove = !0), r.speed = t.data("speed"), isNaN(r.speed) && (r.speed = l.st.block.speed), r.easing = t.data("easing"), r.easing || (r.easing = l.st.block.easing), r.css3Easing = e.rsCSS3Easing[r.easing], r.delay = t.data("delay"), isNaN(r.delay) && (r.delay = l.st.block.delay * i)), _ = {}, l._e && (_[l._g + l._u1] = "0ms"), _.moveProp = s.moveProp, _.opacity = s.opacity, _.display = "none", l._r4.push({
                    block: t,
                    css: _
                }), l._v4(t, n), l._s4.push(setTimeout(function(e, i, t, s) {
                    return function() {
                        if (e.css("display", "block"), t) {
                            var n = {};
                            if (l._e) {
                                var r = "";
                                t.hasMove && (r += t.moveProp), t.hasFade && (t.hasMove && (r += ", "), r += "opacity"), n[l._g + l._t1] = r, n[l._g + l._u1] = t.speed + "ms", n[l._g + l._v1] = t.css3Easing, e.css(n), setTimeout(function() {
                                    e.css(i)
                                }, 24)
    ...
    e.extend(e.rsProto, {
        _w4: function() {
            ...
            if (e.st.autoHeight) {
                var i, t, s, n = !0,
                    r = function(r) {
                        s = e.slides[e.currSlideId], (i = s.holder) && (t = i.height()) && void 0 !== t && t > (e.st.minAutoHeight || 30) && (e._c4 = t, e._e || !r ? e._e1.css("height", t) : e._e1.stop(!0, !0).animate({
                            height: t
                        }, e.st.transitionSpeed), e.ev.trigger("rsAutoHeightChange", t), n && (e._e && setTimeout(function() {
...
function(e) {
    e.extend(e.rsProto, {
        _d6: function() {
            var i = this;
            i.st.globalCaption && (i.ev.on("rsAfterInit", function() {
...
function(e) {
    e.rsProto._o4 = function() {
        var e, i = this;
        i.st.addActiveClass && i.ev.on("rsOnUpdateNav", function() {
            ...
            if (n._p5 = {
                ...
                var r = n.st.deeplinking.change,
                    ...
                    d = function() {
                        ...
                        return e && 0 < e.indexOf(o) && (e = parseInt(e.substring(a.length), 10), e >= 0) ? e - 1 : -1
                    },
                    l = d(); - 1 !== l && (n.st.startSlideId = l), r && (e(window).on("hashchange" + n.ns, function(e) {
                    i || (e = d(), 0 > e || (e > n.numSlides - 1 && (e = n.numSlides - 1), n.goTo(e)))
                }), n.ev.on("rsBeforeAnimStart", function() {
                    t && clearTimeout(t), s && clearTimeout(s)
                }), n.ev.on("rsAfterSlideChange", function() {
                    t && clearTimeout(t), s && clearTimeout(s), s = setTimeout(function() {
                        i = !0, window.location.replace(("" + window.location).split("#")[0] + a + (n.currSlideId + 1)), t = setTimeout(function() {
                            i = !1, t = null
                        }, 60)
                    }, 400)
...
function(e, i, t) {
    ...
    var n, r = document,
        o = e.event.special,
        a = r.documentMode,
        d = "onhashchange" in i && (a === t || a > 7);
    e.fn.hashchange = function(e) {
        return e ? this.bind("hashchange", e) : this.trigger("hashchange")
    }, e.fn.hashchange.delay = 50, o.hashchange = e.extend(o.hashchange, {
        setup: function() {
            return d ? !1 : void e(n.start)
        },
        teardown: function() {
            return d ? !1 : void e(n.stop)
        }
    }), n = function() {
        function n() {
            var t = s(),
        ...
        }, i.attachEvent && !i.addEventListener && !d && function() {
            var i, t;
            a.start = function() {
                i || (t = (t = e.fn.hashchange.src) && t + s(), i = e('<iframe tabindex="-1" title="empty"/>').hide().one("load", function() {
                    t || c(s()), n()
                }).attr("src", t || "javascript:0").insertAfter("body")[0].contentWindow, r.onpropertychange = function() {
                    try {
...
function(e) {
    e.rsProto._g7 = function() {
        ...
        }, i.st.visibleNearby = e.extend({}, i._h7, i.st.visibleNearby), i.ev.one("rsAfterPropsSetup", function() {
            i._i7 = i._e1.css("overflow", "visible").wrap('<div class="rsVisibleNearbyWrap"></div>').parent(), i.st.visibleNearby.hiddenOverflow || i._i7.css("overflow", "visible"), i._o1 = i.st.controlsInside ? i._i7 : i.slider
        }), i.ev.on("rsAfterSizePropSet", function() {
            var e, t = i.st.visibleNearby;
            e = t.breakpoint && i.width < t.breakpoint ? t.breakpointCenterArea : t.centerArea, i._h ? (i._b4 *= e, i._i7.css({
                height: i._c4,
                width: i._b4 / e
            }), i._d = i._b4 * (1 - e) / 2 / e) : (i._c4 *= e, i._i7.css({
                height: i._c4 / e,
                width: i._b4
            }), i._d = i._c4 * (1 - e) / 2 / e), t.navigateByCenterClick || (i._q = i._h ? i._b4 : i._c4), t.center && i._e1.css("margin-" + (i._h ? "left" : "top"), i._d)
        }))
